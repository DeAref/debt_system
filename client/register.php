...
<div class="register-box">
    ...
    <div class="card-body register-card-body">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        <div class="input-group mb-3">
          ...
          <div class="input-group mb-3">
              <input type="text" class="form-control" name="nCode" placeholder="کدملی">
              <div class="input-group-append">
                  <span class="fa fa-heart input-group-text"></span>
              </div>
          </div>
    <div class="input-group mb-3">
      ...
      <div class="input-group mb-3">
          <input type="text" class="form-control" name="bDate" placeholder=" تاریخ تولد">
          <div class="input-group-append">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" name="password2" placeholder="تکرار رمز عبور">
          <div class="input-group-append">
            <span class="fa fa-lock input-group-text"></span>
          </div>
        </div>
          <div class="input-group mb-3">
              ...
              <input type="file" class="form-control" value="" name="fileToUpload">
              <div class="input-group-append">
                  <span class="fa fa-file input-group-text"></span>
              </div>
          </div>
        <div class="row">
          <div class="col-8">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat">ثبت نام</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
  ...
  <button type="submit" class="link" name="back2login" value="login">من قبلا ثبت نام کرده ام</button>
</form>
