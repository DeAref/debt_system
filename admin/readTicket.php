...
if(isset($_POST['sendReplyTicket'])){
    ...
    $query ="INSERT INTO `conversation` (`id`, `Ticket_ID`, `date`, `name`, `Text`) VALUES (NULL, '$ticket_id', '$systemDate', '$nameLname', '$textReply');";
    $result = mysqli_query($conn,$query);
    $query2="UPDATE `ticket` SET `ticket_status` = '1' WHERE `ticket`.`id` = '$ticket_id';";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            <a href="ticketList.php" class="btn btn-primary btn-block mb-3">برگشت به اینباکس</a>
